var namePolitician = function(name, partyColor) {
...
var candidate1 = namePolitician("Elizabeth Warren", [132, 17, 11]);
var candidate2 = namePolitician("Bernie Sanders", [245, 141, 136]);
...
var stateInfoTable =  document.getElementById("stateResults");
    ...
    candidateResults1.innerText = candidate1.electionResults[state];
    candidateName2.innerText = candidate2.name;
    candidateResults2.innerText = candidate2.electionResults[state];
...
//candidate colors
console.log("Elizabeth's color is: " + candidate1.partyColor);
console.log("Bernie's color is: " + candidate2.partyColor);
